	...
	<div class="d-md-flex align-items-md-center justify-content-between">
		<div class="media m-v-10 align-items-center">
			<div class="media-body m-l-15">
				<h4 class="m-b-0">Actualizar Perfil.</h4>
			</div>
		</div>
	</div>
</div>
		...
		<div class="card sb-card-shadow">
			<div class="card-body">
				...
				<div class="mt-5">
					...
					<form action="<?php echo base_url() ?>accounts/profile" method="post">
						<div class="form-group row">
							<label for="inputEmail3" class="col-sm-3 col-form-label">Email</label>
							<div class="col-sm-9">
								<input type="email" name="user_email" class="form-control" id="inputEmail3" value="<?php echo $user['user_email'] ?>" placeholder="Email">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="tel" name="user_phone" class="form-control" id="inputPassword3" value="<?php echo $user["user_phone"] ?>" placeholder="Numero de telefono">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-12">
