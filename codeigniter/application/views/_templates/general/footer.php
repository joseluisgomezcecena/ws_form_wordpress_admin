...
<script>
	function showToast(param, message)
	{
		if(param == "success")
		{
			var message = message;
		...
		var toastHTML = `<div style="border-radius: .75rem; border: 1px solid rgba(0,0,0,0.125); box-shadow: 0px 8px 10px rgba(0, 0, 0, 0.1)" class="toast fade hide text-center" data-delay="3000">
			<div class="toast-header text-dark text-center ">
				<!--
				<i class="anticon anticon-info-circle text-white m-r-5"></i>
				-->
				&nbsp;&nbsp;<strong style="font-size: 18px; text-align: center;" class="mr-auto text-center">${title}</strong>
...
<script>
	...
	$('#data-table-export').DataTable({
		...
		*/
		buttons: {
			buttons: [
				{ extend: 'copy', className: 'btn-primary btn btn-sm' },
				{ extend: 'excel', className: 'btn-primary btn btn-sm' },
				{ extend: 'csv', className: 'btn-primary btn btn-sm' },
				{ extend: 'pdf', className: 'btn-primary btn btn-sm' },
				{ extend: 'print', className: 'btn-primary btn btn-sm' }
			]
		}
